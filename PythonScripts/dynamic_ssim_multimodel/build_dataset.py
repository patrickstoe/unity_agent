...
train_models = {
    ...
    "dragon_l0": ["dragon_l0", "dragon_l1", "dragon_l2", "dragon_l3"]
}

test_models = {
    # "temple000": ["temple000", "temple001", "temple002", "temple003"]
    "bunny_l0": ["bunny_l0", "bunny_l1", "bunny_l2", "bunny_l3"]
}
...
def get_lod_stats(lod_name):
    ...
    for i, line in enumerate(lines):
        ...
        # The comma in FPS should be converted into a dot to parse the value correctly
        parsed = { field[0]: field[1].replace(',', '.') for field in fields }
